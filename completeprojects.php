                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <h4 class="m-t-0 header-title mb-4"><b>Completed projects</b></h4>
...
WHERE addprojects.project_status = 'completed'
...
?>
                                                    ...
                                                    <td><span class="badge badge-success"><?php print_r($project_status);?></span></td>
