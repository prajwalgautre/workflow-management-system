                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <h4 class="m-t-0 header-title mb-4"><b>View projects</b></h4>
...
?>
                                                    ...
                                                    <td><?php print_r($startdate);?><br> <br><?php print_r($enddate);?></td>
                                                    ...
                                                    <a href="updateproject.php? id=<?php echo($id);?>"type="button"id="btn" class="btn btn-warning waves-effect width-md waves-light">Edit</a>
                                                    <br>
                                                    <a href="deleteproject.php? id=<?php echo($id);?>"type="button" id="btn" class="btn btn-danger waves-effect width-md waves-light">Delete</a>
